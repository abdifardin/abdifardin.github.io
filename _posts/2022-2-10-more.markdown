...
During the last 15 years of development i have done many projects but some of them either i developed using a third-party company/framework or the client never published
   
I just list them here with a short description for reference.
